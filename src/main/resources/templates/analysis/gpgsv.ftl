...
<body>
<table id="dg" title="GPGSV GNSS天空范围内的卫星，可见卫星信息" class="easyui-datagrid"
       url="/getGPGSVList"
       toolbar="#toolbar"
       pagination= true
       striped=true
    ...
    <thead>
    <tr>
        <th field="gsvtotal" width="50">GSV总数</th>
        <th field="gsvnum" width="50">GSV编号</th>
        <th field="satellitetotal" width="50">PRN码（可见卫星总数）</th>
        <#--<th field="gpgsvSatelliteList" width="50">位置精度因子</th>-->
        <#--<th field="gpgsvSatelliteList" width="50">水平精度因子</th>-->
        <#--<th field="gpgsvSatelliteList" width="50">垂直精度因子</th>-->
    </tr>
    </thead>
</table>
